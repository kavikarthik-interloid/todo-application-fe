const Header = ({ handleLogin }) => {
  ...
  const goldHover =
    "relative pb-1 after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-gradient-to-r after:from-[#E6C687] after:via-[#FFF3B3] after:via-[#D4AF37] after:to-[#AA7C11] after:transition-all after:duration-300 group-hover:after:w-full";
  ...
  return (
    <div className="w-full font-serif shadow-lg">
      <div className="fixed w-full px-3 sm:px-5 flex items-center justify-between bg-surface-3/50 shadow-md">
        ...
        <div className="hidden justify-around xl:justify-evenly lg:px-4 xl:px-8 2xl:px-36 w-1/2 items-center font-medium md:flex">
